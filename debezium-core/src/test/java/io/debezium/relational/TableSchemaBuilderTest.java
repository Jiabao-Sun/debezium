...
public class TableSchemaBuilderTest {
    ...
    private DefaultValueConverter defaultValueConverter = (column, defaultValueExpression) -> Optional.of(defaultValueExpression);
    ...
    public void shouldFailToBuildTableSchemaFromNullTable() {
        new TableSchemaBuilder(new JdbcValueConverters(), defaultValueConverter, adjuster, customConverterRegistry,
    ...
    public void shouldBuildTableSchemaFromTable() {
        schema = new TableSchemaBuilder(new JdbcValueConverters(), defaultValueConverter, adjuster, customConverterRegistry,
                SchemaBuilder.struct().build(), false, false)
    ...
    public void customKeyMapperShouldMapMultipleTables() {
        ...
        TableSchema schema2 = new TableSchemaBuilder(new JdbcValueConverters(), defaultValueConverter, adjuster, customConverterRegistry,
                SchemaBuilder.struct().build(), false, false)
